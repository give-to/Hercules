...
public abstract class AbstractTree implements ITree {
   ...
   @Override
    ...
    @Override
    public void setHerculesType(String herculesType){this.herculesType = herculesType;}
    ...
    public String toPrettyString(TreeContext ctx) {
        if (hasLabel())
            return ctx.getKindLabel(this) + ": " + getLabel();
        else
            return ctx.getKindLabel(this);
    }
    ...
    public static class FakeTree extends AbstractTree {
        ...
        @Override
        public String getHerculesType() {
            return this.herculesType;
        }
